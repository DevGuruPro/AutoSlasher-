...
"}")
        ...
        self.setting_table = QTableWidget(self.widget_25)
        if (self.setting_table.columnCount() < 3):
        ...
        self.setting_table.setHorizontalHeaderItem(0, __qtablewidgetitem)
        __qtablewidgetitem1 = QTableWidgetItem()
        __qtablewidgetitem1.setFont(font2);
        self.setting_table.setHorizontalHeaderItem(1, __qtablewidgetitem1)
        __qtablewidgetitem2 = QTableWidgetItem()
        __qtablewidgetitem2.setFont(font2);
        self.setting_table.setHorizontalHeaderItem(2, __qtablewidgetitem2)
        if (self.setting_table.rowCount() < 8):
            self.setting_table.setRowCount(8)
        __qtablewidgetitem3 = QTableWidgetItem()
        self.setting_table.setVerticalHeaderItem(0, __qtablewidgetitem3)
        __qtablewidgetitem4 = QTableWidgetItem()
        self.setting_table.setVerticalHeaderItem(1, __qtablewidgetitem4)
        __qtablewidgetitem5 = QTableWidgetItem()
        self.setting_table.setVerticalHeaderItem(2, __qtablewidgetitem5)
        __qtablewidgetitem6 = QTableWidgetItem()
        self.setting_table.setVerticalHeaderItem(3, __qtablewidgetitem6)
        __qtablewidgetitem7 = QTableWidgetItem()
        self.setting_table.setVerticalHeaderItem(4, __qtablewidgetitem7)
        __qtablewidgetitem8 = QTableWidgetItem()
        self.setting_table.setVerticalHeaderItem(5, __qtablewidgetitem8)
        __qtablewidgetitem9 = QTableWidgetItem()
        self.setting_table.setVerticalHeaderItem(6, __qtablewidgetitem9)
        __qtablewidgetitem10 = QTableWidgetItem()
        self.setting_table.setVerticalHeaderItem(7, __qtablewidgetitem10)
        __qtablewidgetitem11 = QTableWidgetItem()
        self.setting_table.setItem(0, 0, __qtablewidgetitem11)
        __qtablewidgetitem12 = QTableWidgetItem()
        self.setting_table.setItem(0, 1, __qtablewidgetitem12)
        __qtablewidgetitem13 = QTableWidgetItem()
        self.setting_table.setItem(0, 2, __qtablewidgetitem13)
        __qtablewidgetitem14 = QTableWidgetItem()
        self.setting_table.setItem(1, 0, __qtablewidgetitem14)
        __qtablewidgetitem15 = QTableWidgetItem()
        self.setting_table.setItem(1, 1, __qtablewidgetitem15)
        __qtablewidgetitem16 = QTableWidgetItem()
        self.setting_table.setItem(1, 2, __qtablewidgetitem16)
        __qtablewidgetitem17 = QTableWidgetItem()
        self.setting_table.setItem(2, 0, __qtablewidgetitem17)
        __qtablewidgetitem18 = QTableWidgetItem()
        self.setting_table.setItem(2, 1, __qtablewidgetitem18)
        __qtablewidgetitem19 = QTableWidgetItem()
        self.setting_table.setItem(2, 2, __qtablewidgetitem19)
        __qtablewidgetitem20 = QTableWidgetItem()
        self.setting_table.setItem(3, 0, __qtablewidgetitem20)
        __qtablewidgetitem21 = QTableWidgetItem()
        self.setting_table.setItem(3, 1, __qtablewidgetitem21)
        __qtablewidgetitem22 = QTableWidgetItem()
        self.setting_table.setItem(3, 2, __qtablewidgetitem22)
        __qtablewidgetitem23 = QTableWidgetItem()
        self.setting_table.setItem(4, 0, __qtablewidgetitem23)
        __qtablewidgetitem24 = QTableWidgetItem()
        self.setting_table.setItem(4, 2, __qtablewidgetitem24)
        __qtablewidgetitem25 = QTableWidgetItem()
        self.setting_table.setItem(5, 0, __qtablewidgetitem25)
        __qtablewidgetitem26 = QTableWidgetItem()
        self.setting_table.setItem(5, 1, __qtablewidgetitem26)
        __qtablewidgetitem27 = QTableWidgetItem()
        self.setting_table.setItem(5, 2, __qtablewidgetitem27)
        __qtablewidgetitem28 = QTableWidgetItem()
        self.setting_table.setItem(6, 0, __qtablewidgetitem28)
        __qtablewidgetitem29 = QTableWidgetItem()
        self.setting_table.setItem(6, 1, __qtablewidgetitem29)
        __qtablewidgetitem30 = QTableWidgetItem()
        self.setting_table.setItem(6, 2, __qtablewidgetitem30)
        __qtablewidgetitem31 = QTableWidgetItem()
        self.setting_table.setItem(7, 0, __qtablewidgetitem31)
        __qtablewidgetitem32 = QTableWidgetItem()
        self.setting_table.setItem(7, 1, __qtablewidgetitem32)
        __qtablewidgetitem33 = QTableWidgetItem()
        self.setting_table.setItem(7, 2, __qtablewidgetitem33)
        ...
        sizePolicy5.setHeightForWidth(self.setting_table.sizePolicy().hasHeightForWidth())
        self.setting_table.setSizePolicy(sizePolicy5)
        font3 = QFont()
        font3.setPointSize(30)
        self.setting_table.setFont(font3)
        self.setting_table.setAutoScrollMargin(16)
        self.setting_table.setSortingEnabled(False)
        self.setting_table.horizontalHeader().setVisible(True)
        self.setting_table.horizontalHeader().setCascadingSectionResizes(False)
        self.setting_table.horizontalHeader().setMinimumSectionSize(39)
        self.setting_table.horizontalHeader().setDefaultSectionSize(100)
        self.setting_table.horizontalHeader().setHighlightSections(False)
        self.setting_table.horizontalHeader().setProperty("showSortIndicator", False)
        self.setting_table.horizontalHeader().setStretchLastSection(True)
        self.setting_table.verticalHeader().setVisible(False)
        self.setting_table.verticalHeader().setCascadingSectionResizes(False)
        self.setting_table.verticalHeader().setMinimumSectionSize(50)
        self.setting_table.verticalHeader().setDefaultSectionSize(30)

        self.horizontalLayout_17.addWidget(self.setting_table)
...
"}  ")
        ...
        if (self.field_table.columnCount() < 3):
            self.field_table.setColumnCount(3)
        __qtablewidgetitem34 = QTableWidgetItem()
        __qtablewidgetitem34.setFont(font2);
        self.field_table.setHorizontalHeaderItem(0, __qtablewidgetitem34)
        __qtablewidgetitem35 = QTableWidgetItem()
        __qtablewidgetitem35.setFont(font2);
        self.field_table.setHorizontalHeaderItem(1, __qtablewidgetitem35)
        __qtablewidgetitem36 = QTableWidgetItem()
        __qtablewidgetitem36.setFont(font2);
        self.field_table.setHorizontalHeaderItem(2, __qtablewidgetitem36)
        if (self.field_table.rowCount() < 5):
            self.field_table.setRowCount(5)
        __qtablewidgetitem37 = QTableWidgetItem()
        self.field_table.setVerticalHeaderItem(0, __qtablewidgetitem37)
        __qtablewidgetitem38 = QTableWidgetItem()
        self.field_table.setVerticalHeaderItem(1, __qtablewidgetitem38)
        __qtablewidgetitem39 = QTableWidgetItem()
        self.field_table.setVerticalHeaderItem(2, __qtablewidgetitem39)
        __qtablewidgetitem40 = QTableWidgetItem()
        self.field_table.setVerticalHeaderItem(3, __qtablewidgetitem40)
        __qtablewidgetitem41 = QTableWidgetItem()
        self.field_table.setVerticalHeaderItem(4, __qtablewidgetitem41)
        __qtablewidgetitem42 = QTableWidgetItem()
        self.field_table.setItem(0, 0, __qtablewidgetitem42)
        __qtablewidgetitem43 = QTableWidgetItem()
        self.field_table.setItem(0, 1, __qtablewidgetitem43)
        __qtablewidgetitem44 = QTableWidgetItem()
        self.field_table.setItem(1, 0, __qtablewidgetitem44)
        __qtablewidgetitem45 = QTableWidgetItem()
        self.field_table.setItem(1, 1, __qtablewidgetitem45)
        __qtablewidgetitem46 = QTableWidgetItem()
        self.field_table.setItem(2, 0, __qtablewidgetitem46)
        __qtablewidgetitem47 = QTableWidgetItem()
        self.field_table.setItem(2, 1, __qtablewidgetitem47)
        __qtablewidgetitem48 = QTableWidgetItem()
        self.field_table.setItem(3, 0, __qtablewidgetitem48)
        __qtablewidgetitem49 = QTableWidgetItem()
        self.field_table.setItem(3, 1, __qtablewidgetitem49)
        __qtablewidgetitem50 = QTableWidgetItem()
        self.field_table.setItem(4, 0, __qtablewidgetitem50)
        __qtablewidgetitem51 = QTableWidgetItem()
        self.field_table.setItem(4, 1, __qtablewidgetitem51)
        ...
        self.field_table.setFont(font3)
        ...
        self.field_table.horizontalHeader().setMinimumSectionSize(39)
        ...
        self.field_table.verticalHeader().setMinimumSectionSize(50)
        ...
        self.fieldWidget.setFont(font4)
...
"}")
        ...
        sizePolicy5.setHeightForWidth(self.generateF.sizePolicy().hasHeightForWidth())
        self.generateF.setSizePolicy(sizePolicy5)
...
"}")
        ...
        sizePolicy5.setHeightForWidth(self.deleteF.sizePolicy().hasHeightForWidth())
        self.deleteF.setSizePolicy(sizePolicy5)
        palette7 = QPalette()
...
"}")
        ...
        sizePolicy5.setHeightForWidth(self.stopGuid.sizePolicy().hasHeightForWidth())
        self.stopGuid.setSizePolicy(sizePolicy5)
        palette10 = QPalette()
...
"}")
        ...
        sizePolicy5.setHeightForWidth(self.addObst.sizePolicy().hasHeightForWidth())
        self.addObst.setSizePolicy(sizePolicy5)
...
"}")
        ...
        sizePolicy5.setHeightForWidth(self.travelToStart.sizePolicy().hasHeightForWidth())
        self.travelToStart.setSizePolicy(sizePolicy5)
        ...
        self.travelToStart.setFont(font5)
...
"}")
        ...
        sizePolicy5.setHeightForWidth(self.startCurrent.sizePolicy().hasHeightForWidth())
        self.startCurrent.setSizePolicy(sizePolicy5)
        palette13 = QPalette()
        ...
        self.startCurrent.setFont(font5)
...
"}")
        ...
        sizePolicy9.setHeightForWidth(self.stopBoun.sizePolicy().hasHeightForWidth())
        self.stopBoun.setSizePolicy(sizePolicy9)
        palette15 = QPalette()
...
"}")
    ...
    def retranslateUi(self, AS):
        ...
        ___qtablewidgetitem = self.setting_table.horizontalHeaderItem(0)
        ___qtablewidgetitem.setText(QCoreApplication.translate("AS", u"PARAMETER", None));
        ___qtablewidgetitem1 = self.setting_table.horizontalHeaderItem(1)
        ___qtablewidgetitem1.setText(QCoreApplication.translate("AS", u"UNIT", None));
        ___qtablewidgetitem2 = self.setting_table.horizontalHeaderItem(2)
        ___qtablewidgetitem2.setText(QCoreApplication.translate("AS", u"VALUE", None));
        ___qtablewidgetitem3 = self.setting_table.verticalHeaderItem(0)
        ___qtablewidgetitem3.setText(QCoreApplication.translate("AS", u"1", None));
        ___qtablewidgetitem4 = self.setting_table.verticalHeaderItem(1)
        ___qtablewidgetitem4.setText(QCoreApplication.translate("AS", u"3", None));
        ___qtablewidgetitem5 = self.setting_table.verticalHeaderItem(2)
        ___qtablewidgetitem5.setText(QCoreApplication.translate("AS", u"New Row", None));
        ___qtablewidgetitem6 = self.setting_table.verticalHeaderItem(3)
        ___qtablewidgetitem6.setText(QCoreApplication.translate("AS", u"New Row", None));
        ___qtablewidgetitem7 = self.setting_table.verticalHeaderItem(4)
        ___qtablewidgetitem7.setText(QCoreApplication.translate("AS", u"New Row", None));
        ___qtablewidgetitem8 = self.setting_table.verticalHeaderItem(5)
        ___qtablewidgetitem8.setText(QCoreApplication.translate("AS", u"4", None));
        ___qtablewidgetitem9 = self.setting_table.verticalHeaderItem(6)
        ___qtablewidgetitem9.setText(QCoreApplication.translate("AS", u"5", None));
        ___qtablewidgetitem10 = self.setting_table.verticalHeaderItem(7)
        ___qtablewidgetitem10.setText(QCoreApplication.translate("AS", u"6", None));

        __sortingEnabled = self.setting_table.isSortingEnabled()
        self.setting_table.setSortingEnabled(False)
        ___qtablewidgetitem11 = self.setting_table.item(0, 0)
        ___qtablewidgetitem11.setText(QCoreApplication.translate("AS", u"SPEED", None));
        ___qtablewidgetitem12 = self.setting_table.item(0, 1)
        ___qtablewidgetitem12.setText(QCoreApplication.translate("AS", u"%", None));
        ___qtablewidgetitem13 = self.setting_table.item(0, 2)
        ___qtablewidgetitem13.setText(QCoreApplication.translate("AS", u"75", None));
        ___qtablewidgetitem14 = self.setting_table.item(1, 0)
        ___qtablewidgetitem14.setText(QCoreApplication.translate("AS", u"BOUNDARY AVOIDANCE", None));
        ___qtablewidgetitem15 = self.setting_table.item(1, 1)
        ___qtablewidgetitem15.setText(QCoreApplication.translate("AS", u"MM", None));
        ___qtablewidgetitem16 = self.setting_table.item(1, 2)
        ___qtablewidgetitem16.setText(QCoreApplication.translate("AS", u"500", None));
        ___qtablewidgetitem17 = self.setting_table.item(2, 0)
        ___qtablewidgetitem17.setText(QCoreApplication.translate("AS", u"MACHINE WIDTH", None));
        ___qtablewidgetitem18 = self.setting_table.item(2, 1)
        ___qtablewidgetitem18.setText(QCoreApplication.translate("AS", u"MM", None));
        ___qtablewidgetitem19 = self.setting_table.item(2, 2)
        ___qtablewidgetitem19.setText(QCoreApplication.translate("AS", u"900", None));
        ___qtablewidgetitem20 = self.setting_table.item(3, 0)
        ___qtablewidgetitem20.setText(QCoreApplication.translate("AS", u"OFFSET PATH", None));
        ...
        ___qtablewidgetitem24.setText(QCoreApplication.translate("AS", u"OBSTACLE AVOIDANCE", None));
        ___qtablewidgetitem25 = self.setting_table.item(5, 1)
        ___qtablewidgetitem25.setText(QCoreApplication.translate("AS", u"MM", None));
        ___qtablewidgetitem26 = self.setting_table.item(5, 2)
        ___qtablewidgetitem26.setText(QCoreApplication.translate("AS", u"500", None));
        ___qtablewidgetitem27 = self.setting_table.item(6, 0)
        ___qtablewidgetitem27.setText(QCoreApplication.translate("AS", u"FIELD AUTO CORRECT", None));
        ___qtablewidgetitem28 = self.setting_table.item(6, 1)
        ___qtablewidgetitem28.setText(QCoreApplication.translate("AS", u"MM", None));
        ___qtablewidgetitem29 = self.setting_table.item(6, 2)
        ___qtablewidgetitem29.setText(QCoreApplication.translate("AS", u"500", None));
        ___qtablewidgetitem30 = self.setting_table.item(7, 0)
        ___qtablewidgetitem30.setText(QCoreApplication.translate("AS", u"OUT OF BOUNDS TOLERANCE", None));
        ___qtablewidgetitem31 = self.setting_table.item(7, 1)
        ___qtablewidgetitem31.setText(QCoreApplication.translate("AS", u"MM", None));
        ___qtablewidgetitem32 = self.setting_table.item(7, 2)
        ___qtablewidgetitem32.setText(QCoreApplication.translate("AS", u"500", None));
        self.setting_table.setSortingEnabled(__sortingEnabled)
        ...
        ___qtablewidgetitem33 = self.field_table.horizontalHeaderItem(0)
        ___qtablewidgetitem33.setText(QCoreApplication.translate("AS", u"Field Name", None));
        ___qtablewidgetitem34 = self.field_table.horizontalHeaderItem(1)
        ___qtablewidgetitem34.setText(QCoreApplication.translate("AS", u"Delete", None));
        ___qtablewidgetitem35 = self.field_table.horizontalHeaderItem(2)
        ___qtablewidgetitem35.setText(QCoreApplication.translate("AS", u"Regenerate", None));
        ___qtablewidgetitem36 = self.field_table.verticalHeaderItem(0)
        ___qtablewidgetitem36.setText(QCoreApplication.translate("AS", u"1", None));
        ___qtablewidgetitem37 = self.field_table.verticalHeaderItem(1)
        ___qtablewidgetitem37.setText(QCoreApplication.translate("AS", u"3", None));
        ___qtablewidgetitem38 = self.field_table.verticalHeaderItem(2)
        ___qtablewidgetitem38.setText(QCoreApplication.translate("AS", u"4", None));
        ___qtablewidgetitem39 = self.field_table.verticalHeaderItem(3)
        ___qtablewidgetitem39.setText(QCoreApplication.translate("AS", u"5", None));
        ___qtablewidgetitem40 = self.field_table.verticalHeaderItem(4)
        ___qtablewidgetitem40.setText(QCoreApplication.translate("AS", u"6", None));
