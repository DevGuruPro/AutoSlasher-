...
"}  ")
        ...
        sizePolicy5.setHeightForWidth(self.fieldWidget.sizePolicy().hasHeightForWidth())
        self.fieldWidget.setSizePolicy(sizePolicy5)
        palette3 = QPalette()
        ...
        sizePolicy7.setHeightForWidth(self.widget_16.sizePolicy().hasHeightForWidth())
        self.widget_16.setSizePolicy(sizePolicy7)
...
"}")
        ...
        self.deleteF.setPalette(palette6)
...
"}")
        ...
        self.generateF.setPalette(palette7)
...
"}")
        ...
        sizePolicy10.setHeightForWidth(self.naviWidget.sizePolicy().hasHeightForWidth())
        self.naviWidget.setSizePolicy(sizePolicy10)
        palette8 = QPalette()
...
"}")
        ...
        sizePolicy8.setHeightForWidth(self.startExzn.sizePolicy().hasHeightForWidth())
        self.startExzn.setSizePolicy(sizePolicy8)
        ...
        self.startExzn.setPalette(palette16)
...
"}")
        ...
        sizePolicy8.setHeightForWidth(self.stopExzn.sizePolicy().hasHeightForWidth())
        self.stopExzn.setSizePolicy(sizePolicy8)
        palette17 = QPalette()
        ...
        self.stopExzn.setPalette(palette17)
...
"}")
        ...
        sizePolicy10.setHeightForWidth(self.movingPage.sizePolicy().hasHeightForWidth())
        self.movingPage.setSizePolicy(sizePolicy10)
