...
"}")
        ...
        self.settingTable.horizontalHeader().setMinimumSectionSize(39)
        ...
        self.settingTable.horizontalHeader().setProperty("showSortIndicator", False)
...
"}  ")
        ...
        sizePolicy6.setHeightForWidth(self.field_table.sizePolicy().hasHeightForWidth())
        self.field_table.setSizePolicy(sizePolicy6)
...
"}")
        ...
        sizePolicy6.setHeightForWidth(self.sureYes.sizePolicy().hasHeightForWidth())
        self.sureYes.setSizePolicy(sizePolicy6)
...
"}")
        ...
        sizePolicy6.setHeightForWidth(self.sureNo.sizePolicy().hasHeightForWidth())
        self.sureNo.setSizePolicy(sizePolicy6)
        palette5 = QPalette()
...
"}")
        ...
        sizePolicy6.setHeightForWidth(self.startGuid.sizePolicy().hasHeightForWidth())
        self.startGuid.setSizePolicy(sizePolicy6)
...
"}")
        ...
        sizePolicy6.setHeightForWidth(self.startObs.sizePolicy().hasHeightForWidth())
        self.startObs.setSizePolicy(sizePolicy6)
...
"}")
        ...
        sizePolicy6.setHeightForWidth(self.stopObs.sizePolicy().hasHeightForWidth())
        self.stopObs.setSizePolicy(sizePolicy6)
        palette17 = QPalette()
