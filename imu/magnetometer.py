glydeautomation@raspberrypi:~/AutoSlasher-/imu $ cat magnetometer.py 
...
class MagnetometerSensor:
    def __init__(self, address=0x0C, bus_num=1):
        ...
        self.calibrationManager.load_calibration('settings.py')
    ...
    def read_calibrated_data(self):
        ...
        calibrated_x, calibrated_y, calibrated_z = self.calibrationManager.apply_calibration(x, y, z)
        return calibrated_x, calibrated_y, calibrated_z

    def read_heading(self):
        calibrated_x, calibrated_y, _ = self.read_calibrated_data()
        heading = self.calibrationManager.calculate_heading(calibrated_x, calibrated_y)
        return heading
