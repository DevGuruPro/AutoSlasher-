...
def create_3d_mesh_from_2d_points(points, height):  
    ...
    # Create 3D vertices from 2D points  
    vertices = []  
    for point in points:  
    ...
    # Create faces from the triangles for both the base and top  
    faces = []  
...
# Create a Trimesh object from boundary STL mesh  
...
# Loop through each obstacle and create a mesh  
obstacle_meshes = []  
...
# Combine the boundary and obstacle meshes into a single mesh  
...
path = []  
current_position = [0.0, 0.0, 0.0]  # Initialize at origin  
